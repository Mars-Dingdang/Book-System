...
export function LoginForm() {
  ...
  return (
    <form className="panel stack" onSubmit={submit}>
      ...
      <PasswordInput label="密码" name="password" required />
...
export function RegisterForm() {
  ...
  return (
    <form className="panel stack" onSubmit={submit}>
      ...
      <PasswordInput label="密码" name="password" required minLength={6} />
      <PasswordInput label="确认密码" name="confirmPassword" required minLength={6} />
